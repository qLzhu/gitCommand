...
=
git tag                                                    # 列出已有的标签
git tag "vx.xx"                                            # 创建一个轻量标签
git tag -a "vx.xx" -m "This is version xx"                 # 创建一个附注标签
git tag -a "vx.xx" "SHA-1"                                 # 指定提交的校验和创建标签
git show "vx.xx"                                           # 查看标签信息
git tag -d "vx.xx"                                         # 删除标签

git push origin --tags                                     # 推送所有标签到远程仓库
git push "xxx(origin)" "vx.xx"                             # 推送指定标签到远程仓库
```